...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.home.context_processors.cart_count',
            ],
        },
    },
]
...
# ── Google OAuth pipeline — links existing email accounts instead of duplicating ──
SOCIAL_AUTH_PIPELINE = (
    ...
    'apps.accounts.pipeline.associate_by_email',  # ← links existing user by email
